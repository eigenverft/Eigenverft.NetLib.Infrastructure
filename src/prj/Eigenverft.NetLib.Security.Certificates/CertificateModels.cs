...
namespace Eigenverft.NetLib.Security.Certificates
{
...
#pragma warning disable SYSLIB0057 // Required for the net8.0 target.
            // Ephemeral private keys can be incompatible with Windows Schannel server credentials.
            // UserKeySet retains broad TLS-server and non-hosting compatibility.
