...
namespace Eigenverft.NetLib.Configuration.Diagnostics
{
    /// <summary>
    ...
    public static class ConfigurationPrecedenceDiagnosticsExtensions
    {
        ...
        /// </summary>
        /// <param name="builder">The host application builder whose current configuration-provider stack is inspected.</param>
        ...
        /// ]]></code>
        /// </remarks>
        public static TBuilder LogConfigurationResolution<TBuilder>(
