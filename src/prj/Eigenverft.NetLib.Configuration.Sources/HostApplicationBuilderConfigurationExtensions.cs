...
namespace Eigenverft.NetLib.Configuration.Sources
{
    /// <summary>
    /// Provides configuration-source operations for <see cref="IHostApplicationBuilder"/>.
    /// </summary>
    public static class HostApplicationBuilderConfigurationExtensions
    {
        ...
        /// </remarks>
        public static TBuilder ResetToMinimalConfigurationSources<TBuilder>(
