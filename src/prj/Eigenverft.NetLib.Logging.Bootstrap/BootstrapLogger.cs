...
namespace Eigenverft.NetLib.Logging.Bootstrap
{
    /// <summary>
    ...
    public static class BootstrapLogger<TCategoryName>
    {
        ...
        /// JSON file must be supplied by the consuming application. The NetLib has no compile-time Serilog reference and uses
