...
namespace Eigenverft.NetLib.SerilogRelay
{
    ...
    [SuppressMessage("Interoperability", "CA2101:Specify marshaling for P/Invoke string arguments", Justification = "Copied tested platform binding implementation; interop contract is intentionally preserved verbatim.")]
    [SuppressMessage("Performance", "CA1838:Avoid StringBuilder parameters for P/Invokes", Justification = "Copied tested platform binding implementation; interop contract is intentionally preserved verbatim.")]
    internal static class PhysicalMachineBinding
    {
