...
using BootstrapLoggerFacade = Eigenverft.NetLib.Logging.Bootstrap.BootstrapLogger;
using RequiredBootstrapLogger = Eigenverft.NetLib.Logging.Bootstrap.BootstrapLogger<Eigenverft.NetLib.Logging.Deferred.Tests.RequiredSerilogBootstrapLoggerTests>;

namespace Eigenverft.NetLib.Logging.Deferred.Tests
{
    [TestClass]
    [DoNotParallelize]
