...
namespace Eigenverft.NetLib.Infrastructure.Tests.Hosting.Configuration.Diagnostics;

[TestClass]
public sealed class ConfigurationPrecedenceDiagnosticsTests
{
    [TestMethod]
    public void LogConfigurationResolution_LogsProviderOrderAndCollidingKeyResolution()
    {
        ...
        HostApplicationBuilder result = builder.LogConfigurationResolution(logger);
