...
```text
./                         you are here (this readme + Eigenverft.NetLib.Configuration.SwitchableJson.slnx)
../../prj/Eigenverft.NetLib.Configuration.SwitchableJson/    packable class library
../../prj/Eigenverft.NetLib.Configuration.SwitchableJson.Tests/  tests (not packed)
```

Package metadata, license, icon, and release notes live in `src/prj/Eigenverft.NetLib.Configuration.SwitchableJson/NugetAssets/`.
...
Creates one `.nupkg` in `src/prj/Eigenverft.NetLib.Configuration.SwitchableJson/bin/Pack/` containing the library for all selected target frameworks. Test and optional benchmark projects are not packed.
...
Writes library output to `src/prj/Eigenverft.NetLib.Configuration.SwitchableJson/bin/Publish/` for the highest selected target framework. This is a class library, not an executable.
