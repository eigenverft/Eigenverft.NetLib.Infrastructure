...
```text
./                         you are here (this readme + Eigenverft.NetLib.Hosting.DirectoryLayout.slnx)
../../prj/Eigenverft.NetLib.Hosting.DirectoryLayout/    packable class library
../../prj/Eigenverft.NetLib.Hosting.DirectoryLayout.Tests/  tests (not packed)
```

Package metadata, license, icon, and release notes live in `src/prj/Eigenverft.NetLib.Hosting.DirectoryLayout/NugetAssets/`.
...
Creates one `.nupkg` in `src/prj/Eigenverft.NetLib.Hosting.DirectoryLayout/bin/Pack/` containing the library for all selected target frameworks. Test and optional benchmark projects are not packed.
...
Writes library output to `src/prj/Eigenverft.NetLib.Hosting.DirectoryLayout/bin/Publish/` for the highest selected target framework. This is a class library, not an executable.
